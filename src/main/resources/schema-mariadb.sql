...
CREATE TABLE CALENDAR (
  ...
  DAY_KR_NM  VARCHAR(255) NOT NULL,
...
CREATE TABLE SLACK_USER (
  ...
  BOT_IM_CHANNEL   VARCHAR(255) NOT NULL,
  USE_YN       VARCHAR(1) NOT NULL DEFAULT 'Y',  
  INSERT_DT DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  UPDATE_DT DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (USER_ID)
...
/* SLACK 알림 메시지 로그 */
DROP TABLE IF EXISTS SLACK_PUBLISH_MSG;

CREATE TABLE SLACK_PUBLISH_MSG (
  RESORT_ID  VARCHAR(255) NOT NULL,
  BOOKING_DT DATE NOT NULL, 
  ROOM_NM    VARCHAR(255) NOT NULL,
  USER_ID    VARCHAR(255) NOT NULL,
  ...
  ALIVE_YN   VARCHAR(1) NOT NULL DEFAULT 'Y',  
  INSERT_DT  DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  UPDATE_DT  DATETIME NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (RESORT_ID, BOOKING_DT, ROOM_NM, CHANNEL, TS)
)
COMMENT='SLACK 알림 메시지 로그'
COLLATE='utf8_general_ci'
ENGINE=InnoDB
;
ALTER TABLE SLACK_PUBLISH_MSG ADD INDEX IX1_SLACK_PUBLISH_MSG (RESORT_ID, BOOKING_DT, ROOM_NM, ALIVE_YN);
ALTER TABLE SLACK_PUBLISH_MSG ADD INDEX IX2_SLACK_PUBLISH_MSG (CHANNEL, TS);

/* SLACK 구독자 */
DROP TABLE IF EXISTS SLACK_SUBSCRIBER;

CREATE TABLE SLACK_SUBSCRIBER (
...
/* SLACK SUBMISSION DIALOG SESSION */
DROP TABLE IF EXISTS SLACK_SUBMISSION_DIALOG;

CREATE TABLE SLACK_SUBMISSION_DIALOG (
...
COMMENT='SLACK SUBMISSION DIALOG SESSION'
COLLATE='utf8_general_ci'
ENGINE=InnoDB
;
