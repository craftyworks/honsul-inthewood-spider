...
/* SLACK 알림 메시지 로그 */
DROP TABLE IF EXISTS SLACK_NOTI_MSG_LOG;

CREATE TABLE SLACK_NOTI_MSG_LOG (
  RESORT_ID  VARCHAR(255) NOT NULL,
  BOOKING_DT DATE NOT NULL, 
  ROOM_NM    VARCHAR(255) NOT NULL,
  USER_ID    VARCHAR(255) NOT NULL,
...
ENGINE=InnoDB
;
ALTER TABLE SLACK_NOTI_MSG_LOG ADD INDEX IX1_SLACK_NOTI_MSG_LOG (RESORT_ID, BOOKING_DT, ROOM_NM, ALIVE_YN);
ALTER TABLE SLACK_NOTI_MSG_LOG ADD INDEX IX2_SLACK_NOTI_MSG_LOG (CHANNEL, TS);